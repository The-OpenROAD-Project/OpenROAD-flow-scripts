...
def extract_metrics(cwd, platform, design, flow_variant, output):
    ...
    metrics_dict["run__flow__metrics__version"] = "2.1"
    if len(cmdFields) > 1:
...
# ==============================================================================
    ...
    extractTagFromFile("placeopt__area__instance__stdcell__count", metrics_dict,
                       "^instance_count\n-*\n^(\S+)",
                       logPath+"/3_3_resizer.log")
    ...
    extractTagFromFile("detailedplace__design__instance__displacement__max", metrics_dict,
...
# ==============================================================================
    ...
    metrics_dict['clock__latency__min'] = latency_min
    metrics_dict['clock__latency__max'] = latency_max
    metrics_dict['clock__skew__worst'] = skew
...
# ==============================================================================
    ...
    extractTagFromFile("detailedroute__route_wirelength_routed", metrics_dict,
                       "total wire length = +(\S+) um",
                       logPath+"/5_2_TritonRoute.log")

    extractTagFromFile("detailedroute__route__via", metrics_dict,
                       "total number of vias = +(\S+)",
                       logPath+"/5_2_TritonRoute.log")

    extractTagFromFile("detailedroute__route__drc_errors", metrics_dict,
                       "(?i)violation",
