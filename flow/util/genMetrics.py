...
def extract_metrics(cwd, platform, design, flow_variant, output, hier_json):
    ...
    extractGnuTime('detailedplace', metrics_dict, logPath + '/3_7_opendp.log')
