...
add_pdn_ring -grid {grid} -layers {Metal5 TopMetal1} -widths {8.0} -spacings {5.0} -core_offsets {4.5} -connect_to_pads
...
define_pdn_grid -name {CORE_macro_grid_1} -voltage_domains {CORE} -macro -cells {I2cDeviceCtrl} -grid_over_boundary
