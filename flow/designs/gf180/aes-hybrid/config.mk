...
# See the README
export SC_LEF = $(DESIGN_HOME)/$(PLATFORM)/$(DESIGN_NICKNAME)/adjusted-gf180mcu_5LM_1TM_9K_9t_sc.lef
...
export ADDITIONAL_LEFS = $(DESIGN_HOME)/$(PLATFORM)/$(DESIGN_NICKNAME)/hybrid_sites.lef \
