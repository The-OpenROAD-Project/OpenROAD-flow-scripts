...
export MOCK_REGISTERFILE_SPLIT ?= 4

export MOCK_ALU_WIDTH     ?= 64
export MOCK_ALU_OPERATIONS?= ADD

export DESIGN_NAME            = MockAluRegisterFile
export DESIGN_NICKNAME        = mock-aluregisterfile
...
verilog:
	...
	./designs/src/mock-alu/verilog-aluregisterfile.sh
