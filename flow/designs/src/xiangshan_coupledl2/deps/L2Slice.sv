...
module L2Slice(
  ...
  output [163:0] toNextPipeline_0_indata,
  output         toNextPipeline_0_readen,
  output [8:0]   toNextPipeline_0_addr_rd,
  input  [163:0] toNextPipeline_0_outdata,
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        (selected ? toNextPipeline_0_outdata : 164'h0)
        | {27'h0, selected_1 ? toNextPipeline_1_outdata : 137'h0};
  end // always @(posedge)
