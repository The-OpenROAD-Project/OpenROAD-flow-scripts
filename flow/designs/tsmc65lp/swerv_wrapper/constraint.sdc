...
# Timing Constraints
###############################################################################
create_clock -name core_clock -period 8.0000 -waveform {0.0000 4.0000} [get_ports {clk}]
set_clock_uncertainty -setup .250 core_clock
set_clock_uncertainty -hold  .250 core_clock
#set_propagated_clock [get_clocks {core_clock}]
create_clock -name jtag_clock -period 8.0000 -waveform {0.0000 4.0000} [get_ports {jtag_tck}]
...
set_input_delay  4.000 -clock core_clock $input_not_jtag_ports
...
set_output_delay 4.000 -clock core_clock $ports_list
