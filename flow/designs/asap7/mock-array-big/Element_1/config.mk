export DESIGN_NAME = Element_1
export DESIGN_NICKNAME = mock-array-big_Element_1
...
export CORE_AREA = $(shell python3 designs/asap7/mock-array-big/ce_core_area_1.py)
export DIE_AREA = $(shell python3 designs/asap7/mock-array-big/ce_die_area_1.py)
