...
export CORE_AREA = $(shell export MOCK_ARRAY_TABLE="$(MOCK_ARRAY_TABLE)" && python3 designs/asap7/mock-array-big/ce_core_area.py)
export DIE_AREA  = $(shell export MOCK_ARRAY_TABLE="$(MOCK_ARRAY_TABLE)" && python3 designs/asap7/mock-array-big/ce_die_area.py)
