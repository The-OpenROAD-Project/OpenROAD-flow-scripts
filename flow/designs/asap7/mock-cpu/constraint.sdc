...
set_clock_groups -group $clk1_name -group $clk2_name -asynchronous
# -allow_paths
...
set_input_delay -clock $clk2_name -max [expr $clk_period * $max_percent] [match_pins .* input 0]
set_output_delay -clock $clk2_name -max [expr $clk_period * $max_percent] [match_pins .* output 0]
set_input_delay -clock $clk2_name -min [expr $clk_period * $min_percent] [match_pins .* input 0]
set_output_delay -clock $clk2_name -min [expr $clk_period * $min_percent] [match_pins .* output 0]
