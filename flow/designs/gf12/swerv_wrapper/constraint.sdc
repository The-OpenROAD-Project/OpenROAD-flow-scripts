...
set_input_delay 375 -clock vclk_jtag_clock $jtag_ports
set_output_delay 375 -clock vclk_jtag_clock [get_ports "jtag_tdo"]
set_input_delay 750 -clock vclk_core_clock $input_not_jtag_ports
set ports_list [list]
...
set_output_delay 750 -clock vclk_core_clock $ports_list
