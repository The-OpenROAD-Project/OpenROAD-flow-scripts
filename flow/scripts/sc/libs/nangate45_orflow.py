...
def setup(chip):
    ...
    lib.add('model', 'timing', 'nldm', corner,
            os.path.abspath(os.path.join(libdir, 'lib', 'NangateOpenCellLibrary_typical.lib')))

    # lef
    lib.add('model', 'layout', 'lef', stackup,
            os.path.abspath(os.path.join(libdir, 'lef', 'NangateOpenCellLibrary.macro.mod.lef')))

    # gds
    lib.add('model', 'layout', 'gds', stackup,
            os.path.abspath(os.path.join(libdir, 'gds', 'NangateOpenCellLibrary.gds')))


    # Techmap
    lib.add('asic', 'file', 'yosys', 'techmap',
            os.path.join(libdir, 'cells_latch.v'))
