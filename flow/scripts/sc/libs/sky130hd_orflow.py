...
def setup(chip):
    ...
    libdir = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'platforms', 'sky130hd')
    ...
    lib.add('model', 'timing', 'nldm', corner,
            os.path.abspath(os.path.join(libdir, 'lib', 'sky130_fd_sc_hd__tt_025C_1v80.lib')))
    lib.add('model', 'layout', 'lef', stackup,
            os.path.abspath(os.path.join(libdir, 'lef', 'sky130_fd_sc_hd_merged.lef')))
    lib.add('model', 'layout', 'gds', stackup,
            os.path.abspath(os.path.join(libdir, 'gds', 'sky130_fd_sc_hd.gds')))

    # Techmap
    lib.add('asic', 'file', 'yosys', 'techmap',
            os.path.abspath(os.path.join(libdir, 'cells_latch_hd.v')))
