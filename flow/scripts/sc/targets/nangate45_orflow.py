...
def setup(chip):
    ...
    env_vars = {
        ...
        'CL_FILE': os.path.join(openroad_dir, 'flow', 'platforms', 'nangate45', 'cdl', 'NangateOpenCellLibrary.cdl'),
        'TEMPLATE_PGA_CFG': os.path.join(openroad_dir, 'flow', 'platforms', 'nangate45', 'template_pga.cfg'),
        'RCX_RULES': os.path.join(openroad_dir, 'flow', 'platforms', 'nangate45', 'rcx_patterns.rules'),
        ...
        'ADDER_MAP_FILE': os.path.join(openroad_dir, 'flow', 'platforms', 'nangate45', 'cells_adders.v'),
