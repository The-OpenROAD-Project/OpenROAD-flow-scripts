...
def setup(chip):
    ...
    env_vars = {
        ...
        'FILL_CONFIG': os.path.join(openroad_dir, 'flow', 'platforms', 'sky130hd', 'fill.json'),
        'TEMPLATE_PGA_CFG': os.path.join(openroad_dir, 'flow', 'platforms', 'sky130hd', 'template_pga.cfg'),
        'RCX_RULES': os.path.join(openroad_dir, 'flow', 'platforms', 'sky130hd', 'rcx_patterns.rules'),
        ...
        'ADDER_MAP_FILE': os.path.join(openroad_dir, 'flow', 'platforms', 'sky130hd', 'cells_adders_hd.v'),
