...
df1 = df[(df['cell count full'] > MAX_UNGROUP_SIZE) & (df['cell count fast'] <= MAX_UNGROUP_SIZE)]
df2 = df[(df['cell count full'] <= MAX_UNGROUP_SIZE) & (df['cell count fast'] > MAX_UNGROUP_SIZE)]
df3 = df[(df['cell count full'] <= MAX_UNGROUP_SIZE) & (df['cell count fast'] <= MAX_UNGROUP_SIZE)]
df4 = df[(df['cell count full'] > MAX_UNGROUP_SIZE) & (df['cell count fast'] > MAX_UNGROUP_SIZE)]
