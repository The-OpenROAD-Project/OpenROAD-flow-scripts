...
* Ray-based AutoTuner: `openroad_autotuner tune -h`
...
After running an AutoTuner experiment with `openroad_autotuner`, you can generate a graph to understand the results better.
