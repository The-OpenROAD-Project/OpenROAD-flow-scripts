...
| <a name="SYNTH_KEEP_LARGE_MEMORIES"></a>SYNTH_KEEP_LARGE_MEMORIES| Keep memories larger than `SYNTH_MEMORY_MAX_BITS`.| 1|
...
- [SYNTH_KEEP_LARGE_MEMORIES](#SYNTH_KEEP_LARGE_MEMORIES)
